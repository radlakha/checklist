...
This is the default behavior when no specific flag is provided.
...
--due
Specifies an optional due date (in `YYYY-MM-DD` format) to be used with
`--add` when adding a new expected document.
